...
def get_messages_by_project_id(project_id: int) -> List[Dict[str, Any]]:
    """
    Retrieve all messages for a specific project. This is an alias of get_messages_by_project
    with a more consistent naming scheme.
    ...
    """
    return get_messages_by_project(project_id, limit=1000)  # Get up to 1000 messages
